            ...
            <div className='project-details'>
              ...
              <div className='project-footer'>
                ...
                <a
                  className='projectIcon'
                  target='_blank'
                  href='https://github.com/helgisor/React-Store/'
                >
            ...
            <div className='project-details'>
              ...
              <div className='project-footer'>
                ...
                <a
                  className='projectIcon'
                  target='_blank'
                  href='https://github.com/helgisor/Monex/'
                >
                  <FaGithubSquare size={40} />
                </a>
              </div>
            ...
            <div className='project-details'>
              ...
              <div className='project-footer'>
                ...
                <a
                  className='projectIcon'
                  target='_blank'
                  href='https://github.com/helgisor/Meditation-App/'
                >
                  <FaGithubSquare size={40} />
                </a>
              </div>
            ...
            <div className='project-container'>
              ...
              <a href='' className='project-icon'>
                <a
                  className='projectIcon'
                  target='_blank'
                  href='https://agitated-allen-7bd8ed.netlify.app/'
                >
                  <FaHome size={40} />
                </a>
              </a>
            ...
            <div className='project-details'>
              ...
              <div className='project-footer'>
                ...
                <a
                  className='projectIcon'
                  target='_blank'
                  href='https://github.com/helgisor/JSGame/'
                >
                  <FaGithubSquare size={40} />
                </a>
              </div>
